                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <?php foreach($users as $u):?>
                            ...
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url('assets/')?>images/users/2.jpg" alt="user" class="" /> <span class="hidden-md-down"><?php echo $u['name']; ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                                    ...
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted"><?php echo $u['username']; ?></p><a href="pages-profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url('home')?>"><i class="icon-Car-Wheel"></i>Dashboard</a></li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url('user')?>"><i class="icon-Car-Wheel"></i>Users</a></li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url('employee')?>"><i class="icon-Car-Wheel"></i>Employee</a></li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url('product')?>"><i class="icon-Car-Wheel"></i>Products</a></li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url('comment')?>"><i class="icon-Car-Wheel"></i>Comment</a></li>
                    </ul>
                </nav>
